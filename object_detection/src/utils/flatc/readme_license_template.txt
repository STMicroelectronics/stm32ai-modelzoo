...
2.	We cause any modified files to carry prominent notices stating that we
	...
	STMicroelectronics copyright to the original <tbd> copyright; and
3.	We retain, in the Source form that we distribute, all copyright and
	...
	reason why <tbd> original copyright declarations and license heading
...
license terms and that they use parts of <tbd> copyrighted components originally
licensed under Apache 2.0 license. Respecting the original Apache 2.0 license
terms obliges us to retain <tbd> copyright declarations as well as Apache 2.0
file headers.
