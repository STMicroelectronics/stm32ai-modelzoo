...
int32_t app_postprocess_init( AppConfig_TypeDef *App_Config_Ptr)
{
    ...
    App_Config_Ptr->postprocess_type = network_centernet;
    ...
    App_Config_Ptr->postprocess_type = network_yolov2;
    ...
    App_Config_Ptr->postprocess_type = network_ssd;
