...
SSD MobileNetV1 is a **single-shot object detection model** designed for **efficient and low-latency inference** on resource-constrained devices such as mobile and edge platforms.

The model combines the **Single Shot Detector (SSD)** framework with **MobileNetV1** as the backbone network. MobileNetV1 employs **inverted residual blocks and linear bottlenecks**, enabling a strong balance between accuracy and computational efficiency.  
...
The `ssd_mobilenetv1_pt` variant is implemented in **PyTorch** and is commonly used as a lightweight baseline for object detection tasks where **speed, memory footprint, and power efficiency** are critical.
...
| Paper              | [SSD](https://arxiv.org/abs/1512.02325)<br>[MobileNetV1](https://arxiv.org/abs/1704.04861) |
...
| --- | --- | --- | --- |
| [ssd_mobilenetv1_pt](./Public_pretrainedmodel_public_dataset/coco/ssd_mobilenetv1_pt_coco_300/ssd_mobilenetv1_pt_coco_300.onnx) | Float | 3x300x300 | 31.67 |
| [ssd_mobilenetv1_pt](./Public_pretrainedmodel_public_dataset/coco/ssd_mobilenetv1_pt_coco_300/ssd_mobilenetv1_pt_coco_300_qdq_int8.onnx) | Int8 | 3x300x300 | 31.27 |
...
| Model | Format | Resolution | AP50 |
| --- | --- | --- | --- |
| [ssd_mobilenetv1_pt](./ST_pretrainedmodel_public_dataset/coco_person/ssd_mobilenetv1_pt_coco_person_300/ssd_mobilenetv1_pt_coco_person_300.onnx) | Float | 3x300x300 | 43.07 |
| [ssd_mobilenetv1_pt](./ST_pretrainedmodel_public_dataset/coco_person/ssd_mobilenetv1_pt_coco_person_300/ssd_mobilenetv1_pt_coco_person_300_qdq_int8.onnx) | Int8 | 3x300x300 | 43.22 |
...
| Model | Format | Resolution | AP50 |
| --- | --- | --- | --- |
| [ssd_mobilenetv1_pt](./Public_pretrainedmodel_public_dataset/voc/ssd_mobilenetv1_pt_voc_300/ssd_mobilenetv1_pt_voc_300.onnx) | Float | 3x300x300 | 68.76 |
| [ssd_mobilenetv1_pt](./Public_pretrainedmodel_public_dataset/voc/ssd_mobilenetv1_pt_voc_300/ssd_mobilenetv1_pt_voc_300_qdq_int8.onnx) | Int8 | 3x300x300 | 68.68 |
