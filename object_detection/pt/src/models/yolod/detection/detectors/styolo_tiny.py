...
from object_detection.pt.src.models.yolod.detection.backbones.stresnet_tiny import STResNetTiny
...
class STYOLOTiny():
    ...
    def __init__(self, cfg):
        ...
        width = 0.375  # Factor of model width
        ...
        if cfg.model.pretrained and cfg.model.num_classes == 80: 
            ...
            self.model.neck.apply(self.init_yolo)
            self.model.head.apply(self.init_yolo)
