...
from object_detection.pt.src.models.yolod.detection.backbones.darknet import \
    CSPDarknet
from object_detection.pt.src.models.yolod.detection.heads.yolo_head import \
    YOLODHead
from object_detection.pt.src.models.yolod.detection.necks.yolo_pafpn import \
    YOLOPAFPN
...
class YOLODTiny():
    ...
    def __init__(self, cfg):
        ...
        width = self.cfg.model.width or 0.375
