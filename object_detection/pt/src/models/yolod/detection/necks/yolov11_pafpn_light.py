...
class YOLOv11PAFPNLight(nn.Module):
    """
    ...
    def __init__(self, in_channels=[128, 256, 512], out_channels=[64, 128, 256]):
        ...
        # Matching layers
        self.match_c5 = nn.Conv2d(in_channels=c5, out_channels=p5,  kernel_size=1)
        self.match_c4 = nn.Conv2d(in_channels=c4, out_channels=p4, kernel_size=1)
        self.match_c3 = nn.Conv2d(in_channels=c3, out_channels=p3, kernel_size=1)
    ...
    def forward(self, feats):
        c3_, c4_, c5_ = feats["dark3"], feats["dark4"], feats["dark5"]
        c3, c4, c5 = self.match_c3(c3_), self.match_c4(c4_), self.match_c5(c5_)
        # Top-down
