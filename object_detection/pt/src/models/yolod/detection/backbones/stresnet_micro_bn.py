...
class STResNetMicroBN(nn.Module):
    ...
    def __init__(
        ...
        self.bn_proj = nn.BatchNorm2d(64, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.act_proj = activation[activation_choice]
        ...
        self.layer3 = nn.Sequential(
            BasicBlock(128, 256,
                ...
                conv2_custom=nn.Sequential(
                    ...
                    nn.BatchNorm2d(72, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True),
                    activation[activation_choice],
...
if __name__ == "__main__":
    model = STResNetMicroBN()
    ckpt_path = "/public-shared/quark/quarknet/checkpoints/stresnet_micro_bn.pth.tar"
