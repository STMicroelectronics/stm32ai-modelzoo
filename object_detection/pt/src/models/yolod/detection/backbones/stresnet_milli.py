...
class STResNetMilli(nn.Module):
    ...
    def __init__(
        ...
        super(STResNetMilli, self).__init__()
        ...
        self.layer2 = nn.Sequential(
            ...
            BasicBlock(
                ...
                bn1=nn.BatchNorm2d(128),
                conv2=nn.Sequential(
                    nn.Conv2d(128, 72, kernel_size=1, bias=False),
        ...
        self.layer3 = nn.Sequential(
            BasicBlock(
                ...
                conv2=nn.Sequential(
                    nn.Conv2d(256, 120, kernel_size=1, bias=False),
                    nn.Conv2d(120, 120, kernel_size=3, padding=1, bias=False),
                    nn.Conv2d(120, 256, kernel_size=1, bias=False),
                ),
            ...
            BasicBlock(
                conv1=nn.Sequential(
                    nn.Conv2d(256, 168, kernel_size=1, bias=False),
                    nn.Conv2d(168, 168, kernel_size=3, padding=1, bias=False),
                    nn.Conv2d(168, 256, kernel_size=1, bias=False),
                ),
                bn1=nn.BatchNorm2d(256),
                conv2=nn.Sequential(
        ...
        self.layer4 = nn.Sequential(
            BasicBlock(
                conv1=nn.Sequential(
                    nn.Conv2d(256, 160, kernel_size=1, bias=False),
                    nn.Conv2d(160, 160, kernel_size=3, stride=2, padding=1, bias=False),
                    nn.Conv2d(160, 512, kernel_size=1, bias=False),
                ),
                ...
                downsample=nn.Sequential(
                        ...
                        nn.Conv2d(48, 48, kernel_size=1, stride=2, bias=False),
            ...
            BasicBlock(
                conv1=nn.Sequential(
                    nn.Conv2d(512, 168, kernel_size=1, bias=False),
                    nn.Conv2d(168, 168, kernel_size=3, padding=1, bias=False),
                    nn.Conv2d(168, 512, kernel_size=1, bias=False),
                ),
                bn1=nn.BatchNorm2d(512),
                conv2=nn.Sequential(
                    nn.Conv2d(512, 96, kernel_size=1, bias=False),
                    nn.Conv2d(96, 96, kernel_size=3, padding=1, bias=False),
                    nn.Conv2d(96, 512, kernel_size=1, bias=False),
                ),
                bn2=nn.BatchNorm2d(512),
            ),
        )
