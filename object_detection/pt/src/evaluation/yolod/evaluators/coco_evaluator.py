...
from object_detection.pt.src.data.yolod.datasets import COCO_CLASSES
from object_detection.pt.src.utils.yolod import (gather, is_main_process,
                                                 postprocess, synchronize,
...
class COCOEvaluator:
    ...
    def evaluate(
        ...
        for cur_iter, (imgs, _, info_imgs, ids) in enumerate(
            ...
            with torch.no_grad():
                ...
                outputs[..., 0] *= self.img_size[0]   # cx
                outputs[..., 1] *= self.img_size[1]   # cy
                outputs[..., 2] *= self.img_size[0]   # w
                outputs[..., 3] *= self.img_size[1]   # h
    ...
    def evaluate_prediction(self, data_dict, statistics):
        ...
        if len(data_dict) > 0:
            ...
            # cocoEval.print = lambda *args, **kwargs: None
            cocoEval.evaluate()
            cocoEval.accumulate()
