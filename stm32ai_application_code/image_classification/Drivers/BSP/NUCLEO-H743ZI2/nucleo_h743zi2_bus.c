...
HAL_StatusTypeDef MX_I2C1_Init(I2C_HandleTypeDef *hI2c, uint32_t timing)
{
  ...
  hbus_i2c1.Init.Timing = 0x307075B1;
  hbus_i2c1.Init.OwnAddress1 = 0;
  hbus_i2c1.Init.AddressingMode = I2C_ADDRESSINGMODE_7BIT;
  hbus_i2c1.Init.DualAddressMode = I2C_DUALADDRESS_DISABLE;
  hbus_i2c1.Init.OwnAddress2 = 0;
  hbus_i2c1.Init.OwnAddress2Masks = I2C_OA2_NOMASK;
  hbus_i2c1.Init.GeneralCallMode = I2C_GENERALCALL_DISABLE;
  hbus_i2c1.Init.NoStretchMode = I2C_NOSTRETCH_DISABLE;
  if (HAL_I2C_Init(&hbus_i2c1) != HAL_OK)
  {
    Error_Handler();
  }
  ...
  */
  if (HAL_I2CEx_ConfigDigitalFilter(&hbus_i2c1, 0) != HAL_OK)
  {
    Error_Handler();
  }
...
static void I2C1_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  */
  ...
  PB9     ------> I2C1_SDA
  */
  GPIO_InitStruct.Pin = I2C_CAMERA_SCL_Pin|I2C_CAMERA_SDA_Pin;
