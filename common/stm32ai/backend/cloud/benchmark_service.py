...
from stm32ai.errors import BenchmarkFailure, BenchmarkParameterError
from stm32ai.errors import ModelNotFoundError, WrongTypeError
from stm32ai.types import LOGGER_NAME, CliParameterCompression
from stm32ai.types import CliParameterVerbosity, CliParameters
from stm32ai.types import CliParameterType
    ...
    def wait_for_run(self, benchmarkId: str, timeout=300, pooling_delay=2):
        ...
        while not is_over:
            ...
            if result:
                ...
                if none_counter > 5:
                    logger.error("Benchmark can't start")
                    return None
                none_counter += 1
